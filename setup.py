...
setup(
    name='Sky Music Sheet Maker',  # Why "Music Sheet" and not "Sheet Music"?
    ...
    packages=[
        ...
        *('{PKG}.{}'.format(pkg, PKG=PKG) for pkg in find_packages('python')),
    ],

    python_requires='>=3',  # 3.6 if we use f-strings, which I want.
    install_requires=[
        'Pillow',
        'mido',
    ],
    ...
    entry_points={
        ...
        'console_scripts': [
            '{PKG} = {PKG}.main:main'.format(PKG=PKG),
        ],
    },
